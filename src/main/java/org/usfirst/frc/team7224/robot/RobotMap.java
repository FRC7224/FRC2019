...
public class RobotMap {
    ...
    public static Solenoid pneumaticsSolenoid1  = new Solenoid(0, 1); // Claw open
    public static Solenoid pneumaticsSolenoid2_claww_in  = new Solenoid(0, 2); // Claw in-out
    public static Solenoid pneumaticsSolenoid3_pan  = new Solenoid(0, 3); // pan
